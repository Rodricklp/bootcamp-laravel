...
<div className='p-5 flex space-x-2'>
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-gray-200 -scale-x-100" fill="none"
    ...
    <div className='flex-1'>
        <div className='flex justify-between items-center'>
            <div>
                ...
                {post.created_at !== post.updated_at && <small className='text-sm text-cyan-200'>&middot;
                    editado</small>}
            </div>
            ...
            <Dropdown>
                ...
                <Dropdown.Content>
                    <button
                        className='block w-full px-4 py-2 text-left text-sm leading-5 text-gray-700 hover:bg-gray-800 focus:bg-gray-800 transition duration-150 ease-in-out dark:text-gray-200'
        ...
        { editing
            ? <form onSubmit={submit}>
                ...
                <div className='space-x-2'>
                    ...
                    <button className='inline-flex items-center px-4 py-2 bg-gray-800 dark:bg-red-200 border border-transparent rounded-md font-semibold text-xs text-white dark:text-gray-800 uppercase tracking-widest hover:bg-gray-700 dark:hover:bg-white focus:bg-gray-700 dark:focus:bg-white active:bg-gray-900 dark:active:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150'
